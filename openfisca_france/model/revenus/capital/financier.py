...
class f2tu(Variable):
    ...
    unit = 'currency'
    entity = FoyerFiscal
    label = u"Pertes en capital sur prêts participatifs en 2016 à reporter sur l'année courante"
    # start_date = date(2017, 1, 1)
    definition_period = YEAR
...
class f2tv(Variable):
    ...
    unit = 'currency'
    entity = FoyerFiscal
    label = u"Pertes en capital sur prêts participatifs en 2017 à reporter sur l'année courante"
    # start_date = date(2017, 1, 1)
    definition_period = YEAR
